...
```{r}
intersect(rownames(cad31.AD.cad31.toptag$table), rownames(j147.toptag$table))
intersect(rownames(cad31.wt.cad31.toptag$table), rownames(cad31.old.cad31.toptag$table))
```
